...
**Explanation:** Creates and runs a pod named "hello-world" using a default image. This is the quickest way to deploy a simple containerized application to your Kubernetes cluster without writing any configuration files.

---

### `kubectl cluster-info`
**Explanation:** Displays information about the Kubernetes cluster, including the API server endpoint, DNS service location, and other control plane details. Useful for verifying cluster connectivity and getting cluster metadata.
